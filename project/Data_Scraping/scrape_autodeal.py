...
# Data scrapped from https://www.autodeal.com.ph/
...
def scrape_page(url, writer):
    ...
    for car in car_elements:
        ...
        hot_deal_price_element = car.select_one('h4.nomargin.padtop.padbottom20')
        car_price = hot_deal_price_element.text.strip() if hot_deal_price_element else 'N/A'

        car_mileage_element = car.select_one('div.padbottom20 span.padright.small.reducedopacity')
...
with open('scraped_data1.csv', 'w', newline='', encoding='utf-8') as csvfile:
